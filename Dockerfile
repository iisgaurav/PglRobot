...
RUN git clone -b shiken https://github.com/gaurav-25/LaylaRobot /root/LaylaRobot
...
RUN git clone -b shiken https://github.com/AnimeKaizoku/PglRobot /root/PglRobot
