...
from PglRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
...
def export_data(update, context):
    ...
    f = open("PglRobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `PglRobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
